...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Shadab\Customproduct\Model\Products::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->messageManager->addExceptionMessage($e, __('Something went wrong while saving the Products.'));
            }
