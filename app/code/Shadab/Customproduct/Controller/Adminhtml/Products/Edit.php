...
class Edit extends \Shadab\Customproduct\Controller\Adminhtml\Products
{
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? __('Edit Products %1', $model->getSku()) : __('New Product'));
        return $resultPage;
    }
}
